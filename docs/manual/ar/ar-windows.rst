...
To do that, just add the following to the agent’s ospatrol.conf:
...
Adding the following to ospatrol.conf will enable the responses for alerts above
level 6:
...
If you run into any issues, look at the ospatrol.log file (on the agent) for any
entry for ospatrol-execd. If you enabled it correctly, you will see:

.. code-block:: 

    2008/08/20 11:53:49 ospatrol-execd: INFO: Started (pid: 3896).
